<x-adminLay>
    <div class="px-4 py-2 bg-white rounded shadow-lg">
        <h1 class="mt-3 mb-5 text-xl font-semibold text-center md:text-start">Import Data Mahasiswa</h1>
            ...
            <div class="my-3">
                <label for="data_mhs"
                    ...
                    <input type="file" id="data_mhs"
                        ...
                        placeholder="Data Mahasiswa" value="{{ old('data_mhs') }}" name="data_mhs" />
