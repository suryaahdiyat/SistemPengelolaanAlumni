<x-adminLay>
    <div class="px-4 py-2 bg-white rounded shadow-lg">
        ...
        <form action="{{ route('stase.update', $stase->kode_stase) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="my-3">
                <label for="nama_stase"
                    ...
                    <input type="text" id="nama_stase"
                        ...
                        placeholder="Nama Stase" value="{{ old('nama_stase') ?? $stase->nama_stase }}" name="nama_stase" />
            ...
            <div class="my-3">
                <label for="kode_stase"
                    ...
                    <input type="text" id="kode_stase"
                        class="w-full p-2 placeholder-transparent bg-transparent border-none peer focus:border-transparent focus:outline-none focus:ring-0"
                        placeholder="Kode Stase" value="{{ old('kode_stase') ?? $stase->kode_stase }}" name="kode_stase" />
            ...
            <div class="my-3">
                <label for="durasi"
                    ...
                    <input type="text" id="durasi"
                        class="w-full p-2 placeholder-transparent bg-transparent border-none peer focus:border-transparent focus:outline-none focus:ring-0"
                        placeholder="Durasi" value="{{ old('durasi') ?? $stase->durasi }}" name="durasi" />
